...
public class StuggeIlias extends IliasPlugin {
	...
	public LoginStatus login(String username, String password) {
		...
		try {
			post = new HttpPost("https://ilias3.uni-stuttgart.de/login.php?target=");
			...
			Element form = doc.select("form[action*=ilias").first();
			...
			post = new HttpPost("https://ilias3.uni-stuttgart.de/Shibboleth.sso/SAML2/POST");
